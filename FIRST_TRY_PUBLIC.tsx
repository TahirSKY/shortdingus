...
const VOICE_URL = "https://rfbrxohavioeaexhztxa.supabase.co/storage/v1/object/public/images/b6caa60b-fd4f-4537-a603-4ac1038647f8-voice.wav";

const IMAGES = [
  "https://rfbrxohavioeaexhztxa.supabase.co/storage/v1/object/public/images/b6caa60b-fd4f-4537-a603-4ac1038647f8-brainbank-1.png",
  "https://rfbrxohavioeaexhztxa.supabase.co/storage/v1/object/public/images/b6caa60b-fd4f-4537-a603-4ac1038647f8-brainbank-2.png",
  "https://rfbrxohavioeaexhztxa.supabase.co/storage/v1/object/public/images/b6caa60b-fd4f-4537-a603-4ac1038647f8-brainbank-3.png",
  "https://rfbrxohavioeaexhztxa.supabase.co/storage/v1/object/public/images/b6caa60b-fd4f-4537-a603-4ac1038647f8-brainbank-4.png",
  "https://rfbrxohavioeaexhztxa.supabase.co/storage/v1/object/public/images/b6caa60b-fd4f-4537-a603-4ac1038647f8-brainbank-5.png",
  "https://rfbrxohavioeaexhztxa.supabase.co/storage/v1/object/public/images/b6caa60b-fd4f-4537-a603-4ac1038647f8-brainbank-6.png",
  "https://rfbrxohavioeaexhztxa.supabase.co/storage/v1/object/public/images/b6caa60b-fd4f-4537-a603-4ac1038647f8-brainbank-7.png"
];
...
function Background({ frame }) {
  ...
  const idx = captionPhrases.indexOf(activeCaption || captionPhrases[0]);
  // Map caption index to image: 0-3 myth, 4-6 emerald, 7-11 garage, 12-16 zuck, 17-24 runway, 25-27 safetynet, 28-31 pool, 32-33 subscribe
  let imageIdx = 0;
  if (idx <= 3) imageIdx = 0;
  else if (idx <= 6) imageIdx = 1;
  else if (idx <= 11) imageIdx = 2;
  else if (idx <= 16) imageIdx = 3;
  else if (idx <= 24) imageIdx = 4;
  else if (idx <= 27) imageIdx = 6;
  else if (idx <= 31) imageIdx = 5;
  else imageIdx = 6;
